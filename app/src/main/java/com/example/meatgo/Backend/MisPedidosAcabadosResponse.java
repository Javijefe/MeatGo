...
public class MisPedidosAcabadosResponse {
    ...
    public MisPedidosAcabadosResponse(Integer id_pedido, String estado, List<CestaResponse.ProductoCesta> productos, Float total) {
